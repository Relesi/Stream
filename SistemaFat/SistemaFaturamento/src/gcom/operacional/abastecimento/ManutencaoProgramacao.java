...
public class ManutencaoProgramacao extends ObjetoTransacao {
    ...
    public ManutencaoProgramacao(Date dataInicio, Date dataFim, Date horaInicio, String descricao, 
    	...
    	gcom.operacional.SistemaAbastecimento sistemaAbastecimento, Municipio municipio, Bairro bairro, 
    	gcom.operacional.SetorAbastecimento setorAbastecimento, gcom.operacional.
    	DistritoOperacional distritoOperacional, gcom.operacional.ZonaAbastecimento zonaAbastecimento, 
    ...
    public ManutencaoProgramacao(Date dataInicio, Date dataFim, Date horaInicio, String descricao, short situacao, 
    		...
    		gcom.operacional.ZonaAbastecimento zonaAbastecimento, 
    		BairroArea bairroArea) {
