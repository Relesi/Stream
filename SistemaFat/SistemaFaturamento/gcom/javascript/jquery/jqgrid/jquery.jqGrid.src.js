...
$.fn.jqGrid = function( pin ) {
	...
	return this.each( function() {
		...
		var arf = ts.p.hidegrid===true ? $("<a role='link' href='javascript:void(0)'/>").addClass('ui-jqgrid-titlebar-close HeaderButton ui-corner-all').hover(
		...
		//MODIFICADO. ADICAO DO BOTAO CLOSE
		$(grid.cDiv).append("<div style='float: right; margin-right: 20px; ' id='closeGrid' ><a class='ui-jqdialog-titlebar-close ui-corner-all' href='javascript:void(0)' style='right: 0.3em;'><span class='ui-icon ui-icon-closethick'></span></a></div>");
		$("#closeGrid").hover(
				function(){ 
					var closeGrid = document.getElementById('closeGrid');
					closeGrid.className = 'ui-jqdialog-titlebar-close ui-corner-all ui-state-hover';
				},
				function() {
					var closeGrid = document.getElementById('closeGrid');
					closeGrid.className = 'ui-jqdialog-titlebar-close ui-corner-all';
				}	
		).
		click(function () {
			 disablePopup();
...
$.jgrid.extend({
	searchGrid : function (p) {
		...
		return this.each(function() {
			...
			//MODIFICACAO. SUBIR O SCROLL DA TELA AO CLICAR NO BOTAO PROCURAR
			scroll(0,0);
