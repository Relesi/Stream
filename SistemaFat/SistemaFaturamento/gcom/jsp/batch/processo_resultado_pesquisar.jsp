	...
	<tr>
		...
		<table width="100%" border="0" bgcolor="#90c7fc">
			...
			<pg:pager isOffset="true" index="half-full" maxIndexPages="10"
				...
				<pg:param name="q" />
				<%int cont = 0;%>
				<logic:present name="colecaoProcesso" scope="session">
				<logic:iterate name="colecaoProcesso" id="processo">
					...
					<%	}	%>
							...
							<td align="center">
							    <a href="javascript:enviarDados('<bean:write name="processo" property="id"/>', '<bean:write name="processo" property="descricaoProcesso"/>', 'processo');">
		...
		<table width="100%" border="0">
			<tr>
				<td height="24"><input type="button" class="bottonRightCol"
					...
					onclick="window.location.href='<html:rewrite page="/exibirPesquisarProcessoAction.do?novaPesquisa=OK&objetoConsulta=1"/>'" /></td>
			</tr>
		</table>
